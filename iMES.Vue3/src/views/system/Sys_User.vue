...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormOptions = ref([[{"title":"帐号","required":true,"field":"UserName","disabled":true},{"title":"姓名","required":true,"field":"UserTrueName","type":"text"}],
                   
                              [{"dataKey":"tree_roles","data":[],"title":"角色","required":true,"field":"Role_Id","type":"cascader"},{"dataKey":"enable","data":[],"title":"是否可用","required":true,"field":"Enable","type":"select"}],
                              [{"dataKey":"组织机构","data":[],"title":"组织构架","field":"DeptIds","colSize":12,"type":"treeSelect"}],
                              [{"title":"备注","field":"Remark","colSize":12,"type":"textarea"}],
                              [{"title":"头像","field":"HeadImageUrl","type":"img"},{"dataKey":"gender","data":[],"title":"性别","field":"Gender","type":"select"}]]);
            ...
            const columns = ref([{field:'User_Id',title:'User_Id',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'UserTrueName',title:t("姓名"),type:'string',width:120,require:true,align:'left'},
