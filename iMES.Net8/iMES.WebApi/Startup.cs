...
namespace iMES.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            WorkFlowContainer.Instance.Use<Ware_OutWareHouseBill>().Run();
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                {
                    // Inject a dev/test user — remove in production
                    var claims = new[] { new Claim(ClaimTypes.Name, "dev"), new Claim(ClaimTypes.Role, "Administrator") };
